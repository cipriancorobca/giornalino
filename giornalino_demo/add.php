...
<html>
    ...
    <body>
        ...
        <div class="maindiv">
            <form method="POST" action="upload.php">
                <?php
                    ...
                    $query1 = "INSERT INTO id21090150_giornalino.tblarticoli (titolo,contenuto,categoria,dataP,scrittore)
        ...
        <div>
            <h2 style="margin-left:45%;">Article saved!</h2><br>
            <h3>The article will reach the <br>
                public after a quality check</h3><br>
        </div>
